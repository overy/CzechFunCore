...
# Dumping data for table characters.creature_respawn: ~6 rows (approximately)
...
# Dumping data for table characters.instance_reset: ~71 rows (approximately)
...
# Dumping data for table characters.pool_quest_save: ~19 rows (approximately)
