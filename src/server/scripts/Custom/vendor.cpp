...
#define mount_other 70 // zelva atp.
...
#define cena_frost 10 // cena EoF
#define cena_triumph 5 // cena EoT
#define cena_conq 1 // cena EoC
#define cena_bravery 3 // cena bravery
...
bool race_change(Player *player, Creature *_creature)
    ...
    bool OnGossipSelect(Player *player, Creature *_creature, uint32 sender, uint32 uiAction)
    {
        if (sender == GOSSIP_SENDER_MAIN)
        {
            ...
            case 2: //Mounts
                 player->ADD_GOSSIP_ITEM(7, "Celestial Steed 70 EM (ID: 54811)", GOSSIP_SENDER_MAIN, 12);
                 player->ADD_GOSSIP_ITEM(7, "Swift Zulian Tiger 30 EM (ID: 19902)", GOSSIP_SENDER_MAIN, 13);
                 player->ADD_GOSSIP_ITEM(7, "Deathcharger 30 EM (ID: 13335)", GOSSIP_SENDER_MAIN, 14);
                 player->ADD_GOSSIP_ITEM(7, "Mimiron's Head 40 EM (ID: 45693)", GOSSIP_SENDER_MAIN, 15);
                 player->ADD_GOSSIP_ITEM(7, "Brutal Nether Drake 50 EM (ID: 43516)", GOSSIP_SENDER_MAIN, 16);
                 player->ADD_GOSSIP_ITEM(7, "Invincible 70 EM (ID: 50818)", GOSSIP_SENDER_MAIN, 17);
                 player->ADD_GOSSIP_ITEM(7, "Magic Broom 50 EM (ID: 37011)", GOSSIP_SENDER_MAIN, 18);
                 player->ADD_GOSSIP_ITEM(7, "Swift Spectral Tiger 30 EM (ID: 49284)", GOSSIP_SENDER_MAIN, 19);
                 player->ADD_GOSSIP_ITEM(7, "White Polar Bear 30 EM (ID: 43962)", GOSSIP_SENDER_MAIN, 20);
                 player->ADD_GOSSIP_ITEM(7, "Teal Kodo 30 EM (ID: 15293)", GOSSIP_SENDER_MAIN, 21);
                 player->ADD_GOSSIP_ITEM(7, "Raven Lord 30 EM (ID: 32768)", GOSSIP_SENDER_MAIN, 22);
                 player->ADD_GOSSIP_ITEM(7, "Black Qiraji Battle Tank 30 EM (ID: 21176)", GOSSIP_SENDER_MAIN, 23);
                 player->ADD_GOSSIP_ITEM(7, "Green Proto-Drake 40 EM (ID: 44707)", GOSSIP_SENDER_MAIN, 24);
                 player->ADD_GOSSIP_ITEM(7, "Red Proto-Drake 40 EM (ID: 44160)", GOSSIP_SENDER_MAIN, 25);
                 player->ADD_GOSSIP_ITEM(7, "Riding Turtle 70 EM (ID: 23720)", GOSSIP_SENDER_MAIN, 26);
                 player->ADD_GOSSIP_ITEM(7, "Sea Turtle 70 EM (ID: 46109)", GOSSIP_SENDER_MAIN, 27);
                 player->ADD_GOSSIP_ITEM(7, "Swift White Hawkstrider 30 EM (ID: 35513)", GOSSIP_SENDER_MAIN, 28);
                 player->ADD_GOSSIP_ITEM(7, "Wooly White Rhino 30 EM (ID: 54068)", GOSSIP_SENDER_MAIN, 29);
                 player->ADD_GOSSIP_ITEM(4, "<< Zpet", GOSSIP_SENDER_MAIN, 0);
                 player->SEND_GOSSIP_MENU(50002, _creature->GetGUID());
                 break;

            case 3: //Non-combat peti
                 player->ADD_GOSSIP_ITEM(7, "Dragon Kite 30 EM" , GOSSIP_SENDER_MAIN, 30);
                 player->ADD_GOSSIP_ITEM(7, "Hippogryph Hatchling 30 EM", GOSSIP_SENDER_MAIN, 31);
                 player->ADD_GOSSIP_ITEM(7, "Tuskarr Kite 30 EM", GOSSIP_SENDER_MAIN, 32);
                 player->ADD_GOSSIP_ITEM(7, "White Tiger Cub 30 EM", GOSSIP_SENDER_MAIN, 33);
                 player->ADD_GOSSIP_ITEM(7, "Parrot Cage (Hyacinth Macaw) 30 EM", GOSSIP_SENDER_MAIN, 34);
                 player->ADD_GOSSIP_ITEM(7, "Goblin Weather Machine - Prototype 01-B 30 EM", GOSSIP_SENDER_MAIN, 35);
                 player->ADD_GOSSIP_ITEM(7, "Banana Charm 30 EM", GOSSIP_SENDER_MAIN, 36);
               //player->ADD_GOSSIP_ITEM(7, "Armadillo Pup 30 EM", GOSSIP_SENDER_MAIN, 37);
                 player->ADD_GOSSIP_ITEM(7, "Frosty's Collar 30 EM", GOSSIP_SENDER_MAIN, 38);
                 player->ADD_GOSSIP_ITEM(7, "Blue Clockwork Rocket Bot 30 EM", GOSSIP_SENDER_MAIN, 39);
                 player->ADD_GOSSIP_ITEM(7, "Core Hound Pup 30 EM", GOSSIP_SENDER_MAIN, 40);
                 player->ADD_GOSSIP_ITEM(7, "Elwynn Lamb 30 EM", GOSSIP_SENDER_MAIN, 41);
                 player->ADD_GOSSIP_ITEM(4, "<< Zpet", GOSSIP_SENDER_MAIN, 0);
                 player->SEND_GOSSIP_MENU(50003, _creature->GetGUID());
                 break;

            case 4: //PVE a PVP
				player->ADD_GOSSIP_ITEM(7, "Commendation of Bravery, Cena 14 000 honoru: 3 EM", GOSSIP_SENDER_MAIN, 45);
                player->ADD_GOSSIP_ITEM(7, "Emblem of Frost, Cena 5 emblemu: 10 EM", GOSSIP_SENDER_MAIN, 44);
                player->ADD_GOSSIP_ITEM(7, "Emblem of Triumph, Cena 5 emblemu: 5 EM", GOSSIP_SENDER_MAIN, 43);
            ...
            case 15: //Mimiron's Head
             if(!AddMount(player, _creature, mount_310, 45693))
                    return false;
                break;
			...
			case 45: //bravery 45706
             if(!AddBravery(player, _creature, cena_bravery, 45706))
                    return false;
                break;
