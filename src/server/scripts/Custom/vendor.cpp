...
#define mount_other     70                //    �elva atp.
    ...
    bool OnGossipSelect(Player *player, Creature *_creature, uint32 sender, uint32 uiAction)
    {
        if (sender == GOSSIP_SENDER_MAIN)
        {
		 ...
		 player->ADD_GOSSIP_ITEM(10, "Zmena rasy 10 EM", GOSSIP_SENDER_MAIN, 654);
            ...
            case 2: //Mounts
                 player->ADD_GOSSIP_ITEM(7, "Celestial Steed 70 EM", GOSSIP_SENDER_MAIN, 12);
                 player->ADD_GOSSIP_ITEM(7, "Swift Zulian Tiger 30 EM", GOSSIP_SENDER_MAIN, 13);
                 player->ADD_GOSSIP_ITEM(7, "Deathcharger 30 EM", GOSSIP_SENDER_MAIN, 14);
                 player->ADD_GOSSIP_ITEM(7, "Mimiron's Head 40 EM", GOSSIP_SENDER_MAIN, 15);
                 player->ADD_GOSSIP_ITEM(7, "Brutal Nether Drake 50 EM", GOSSIP_SENDER_MAIN, 16);
                 player->ADD_GOSSIP_ITEM(7, "Invincible 70 EM", GOSSIP_SENDER_MAIN, 17);
                 player->ADD_GOSSIP_ITEM(7, "Magic Broom 50 EM", GOSSIP_SENDER_MAIN, 18);
                 player->ADD_GOSSIP_ITEM(7, "Swift Spectral Tiger 30 EM", GOSSIP_SENDER_MAIN, 19);
                 player->ADD_GOSSIP_ITEM(7, "White Polar Bear 30 EM", GOSSIP_SENDER_MAIN, 20);
                 player->ADD_GOSSIP_ITEM(7, "Teal Kodo 30 EM", GOSSIP_SENDER_MAIN, 21);
                 player->ADD_GOSSIP_ITEM(7, "Raven Lord 30 EM", GOSSIP_SENDER_MAIN, 22);
                 player->ADD_GOSSIP_ITEM(7, "Black Qiraji Battle Tank 30 EM", GOSSIP_SENDER_MAIN, 23);
                 player->ADD_GOSSIP_ITEM(7, "Green Proto-Drake 40 EM", GOSSIP_SENDER_MAIN, 24);
                 player->ADD_GOSSIP_ITEM(7, "Red Proto-Drake 40 EM", GOSSIP_SENDER_MAIN, 25);
                 player->ADD_GOSSIP_ITEM(7, "Riding Turtle 70 EM", GOSSIP_SENDER_MAIN, 26);
                 player->ADD_GOSSIP_ITEM(7, "Sea Turtle 70 EM", GOSSIP_SENDER_MAIN, 27);
                 player->ADD_GOSSIP_ITEM(7, "Swift White Hawkstrider 30 EM", GOSSIP_SENDER_MAIN, 28);
                 player->ADD_GOSSIP_ITEM(7, "Wooly White Rhino 30 EM", GOSSIP_SENDER_MAIN, 29);
                 player->ADD_GOSSIP_ITEM(4, "<< Zpet", GOSSIP_SENDER_MAIN, 0);
            ...
            case 4: //Emblemy
                player->ADD_GOSSIP_ITEM(7, "Emblem of Frost, Cena 5 emblemu: 15 EM",        GOSSIP_SENDER_MAIN, 44);
                player->ADD_GOSSIP_ITEM(7, "Emblem of Triumph, Cena 5 emblemu: 10 EM",    GOSSIP_SENDER_MAIN, 43);
                player->ADD_GOSSIP_ITEM(7, "Emblem of Conquest, Cena 5 emblemu: 5 EM",      GOSSIP_SENDER_MAIN, 42);
                player->ADD_GOSSIP_ITEM(4, "<< Zpet", GOSSIP_SENDER_MAIN, 0);
...
/*           
              case 37: //Armadillo Pup
             if(!AddPet(player, _creature, noncmbt_pet,  34493))
                    return false;
                break;

a� od 4.0.1 .. pro p�ehlednost �isel v "case" nechavam!  */
