...
enum Events
{
    ...
    EVENT_STICKY_OOZE       = 7,
	TEMPFIX_EVENT_VILE_GAS_HEROIC = 8,
};
    ...
    public:
        ...
        struct boss_rotfaceAI : public BossAI
        {
            ...
            void Reset()
            {
				...
				if (IsHeroic())
				events.ScheduleEvent(TEMPFIX_EVENT_VILE_GAS_HEROIC, 18000);
                infectionStage = 0;
                infectionCooldown = 14000;
            }
                ...
                while (uint32 eventId = events.ExecuteEvent())
                {
                    switch (eventId)
                    {
                        ...
                        case EVENT_MUTATED_INFECTION:
                            ...
                            break;
						case TEMPFIX_EVENT_VILE_GAS_HEROIC:
                            ...
                            events.ScheduleEvent(TEMPFIX_EVENT_VILE_GAS_HEROIC, urand(28000, 35000));
							}
                            break;
                        default:
                            break;
