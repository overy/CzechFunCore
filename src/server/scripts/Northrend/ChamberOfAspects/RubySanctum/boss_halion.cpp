...
enum 
{
    ...
    SPELL_TWILIGHT_CUTTER                       = 74768, // 77844 dont work (( Inflicts 13,875 to 16,125 Shadow damage every second to players touched by the shadow beam
    //CORPOREALITY
    ...
    EMOTE_WARNING                   = -1666110, // The orbiting spheres pulse with dark energy!
    EMOTE_REAL_1                    = -1666111, // Your companions effort force Halion further into the physical realm!
    EMOTE_TWILIGHT_1                = -1666112, // Your companions effort force Halion further into the twilight realm!
	EMOTE_REAL_2                    = -1666113, // Your efforts force Halion further out of the physical realm!
	EMOTE_TWILIGHT_2                = -1666114, // Your efforts force Halion further out of the twilight realm!
...
public:
    ...
    struct boss_halion_realAI : public ScriptedAI
    {
        ...
        void KilledUnit(Unit* pVictim)
        {
            ...
            {
                case 0:
                    DoScriptText(-1666102,me,pVictim);
                    break;
                case 1:
                    DoScriptText(-1666103,me,pVictim);
                    break;
            }
        }
